...
TBS-W-2_TS-002
	...
	${TS_id}=       Get cell value    3    B   W-2_Scenario
	${TS_desc}=       Get cell value    3    AM   W-2_Scenario
  ...
  #FOR    ${i}    IN RANGE    1    ${rows}
	...
	${EmployeeSSN}=       Get cell value    3    C   W-2_Scenario
	${Wages}=       Get cell value    3    D   W-2_Scenario
	...
	Run Keyword If	${passed2}      writelog    '${logid}','${TS_id}','${TS_desc}','W-2 form should be created with foreign address','W-2 form is created with foreign address','Pass','${TS_id}.png'
 	...        ELSE		writelog    '${logid}','${TS_id}','${TS_desc}','W-2 form should be created with foreign address','W-2 form is not created with foreign address','Fail','${TS_id}.png'